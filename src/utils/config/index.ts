...
export const config = {
  ...
  spa_url: 'https://editor.coupomated.com/editor/data/merchant/coupons?editor_token=',
  create_coupon: 'https://editor.coupomated.com/editor/data/create-coupon?merchant_id=',
